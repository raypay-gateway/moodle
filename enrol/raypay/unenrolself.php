...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'raypay'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/raypay/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_raypay', format_string($course->fullname));
